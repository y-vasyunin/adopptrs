...
if __name__ == '__main__':
    ...
    # Polygons
    with open(os.path.join(args.path, 'SolarArrayPolygons.geojson'), 'r') as f:
        panels = json.load(f)['features']
    # VGG Image Annotations
    via = {}

    for panel in panels:
        filename = panel['properties']['image_name'] + args.ext
        polygon = panel['properties']['polygon_vertices_pixels']
